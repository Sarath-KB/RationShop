...
REPLACE INTO "tbl_member" ("member_id", "member_name", "member_photo", "member_proof", "user_id") VALUES
	('3','Rtgy','photo_1355.jpg','proof_1569.png','1');
...
#
# Table structure for table 'tbl_prooftype'
#

CREATE TABLE /*!32312 IF NOT EXISTS*/ "tbl_prooftype" (
  "prooftype_id" int(10) unsigned NOT NULL auto_increment,
  "prooftype_name" varchar(50) default NULL,
  PRIMARY KEY  ("prooftype_id")
) AUTO_INCREMENT=5;



#
# Dumping data for table 'tbl_prooftype'
#

LOCK TABLES "tbl_prooftype" WRITE;
/*!40000 ALTER TABLE "tbl_prooftype" DISABLE KEYS;*/
REPLACE INTO "tbl_prooftype" ("prooftype_id", "prooftype_name") VALUES
	('1','Aadhar');
REPLACE INTO "tbl_prooftype" ("prooftype_id", "prooftype_name") VALUES
	('2','Pan Card');
REPLACE INTO "tbl_prooftype" ("prooftype_id", "prooftype_name") VALUES
...
REPLACE INTO "tbl_prooftype" ("prooftype_id", "prooftype_name") VALUES
	('4','Election Card');
/*!40000 ALTER TABLE "tbl_prooftype" ENABLE KEYS;*/
UNLOCK TABLES;
...
REPLACE INTO "tbl_user" ("user_id", "user_name", "user_contact", "user_email", "user_address", "user_gender", "location_id", "user_nomember", "user_photo", "user_proof", "povertytype_id", "user_cardno", "user_username", "user_password", "user_status") VALUES
	('1','Sarath','8606749634','sarath3@gmail.com','Muvattupuzha','Male','1','1','photo_1750.jpg','proof_1265.png','6','467678','sarath','sarath1','2');
REPLACE INTO "tbl_user" ("user_id", "user_name", "user_contact", "user_email", "user_address", "user_gender", "location_id", "user_nomember", "user_photo", "user_proof", "povertytype_id", "user_cardno", "user_username", "user_password", "user_status") VALUES
	('2','Anuja','8067453456','a@gmail.com',' Chjkkvvnjk','Female','1','5','photo_1787.jpg','proof_2052.jpg',NULL,'0','Anuja','anuja','0');
