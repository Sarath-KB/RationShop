...
if(isMultipart)
{
   ...
   String str1="insert into tbl_cardrequest(cardrequest_name,cardrequest_address,card_income,cardrequest_nos,cardrequest_photo,cardrequest_proof,user_id)values('"+value[0]+"','"+value[1]+"','"+value[2]+"','"+value[3]+"','"+fn+"','"+proof+"','"+session.getAttribute("uid")+"')";
    ...
    if(status==true)
    {
      %> 
       <script type="text/javascript">
            ...
            setTimeout(function(){window.location.href='../User/RequestNew.jsp'},40);//40millisecend it go to next page
        </script>
     <%
    }
     }    
