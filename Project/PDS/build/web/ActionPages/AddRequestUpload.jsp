...
if(isMultipart)
{
   ...
   String str1="insert into tbl_addrequest(card_number,req_do,req_name,req_proof,user_id)values('"+value[0]+"','"+value[1]+"','"+value[2]+"','"+fn+"','"+session.getAttribute("uid")+"')";
    ...
    if(status==true)
    {
      %> 
       <script type="text/javascript">
            ...
            setTimeout(function(){window.location.href='../User/AddCardMember.jsp'},40);//40millisecend it go to next page
        </script>
     <%
    }
