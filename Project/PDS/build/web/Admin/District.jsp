...
<html>
    ...
    <body>
        ...
        if(request.getParameter("btnsubmit")!=null){
            String ins="insert into tbl_district(district_name)values('"+request.getParameter("txtdis")+"')";
         ...
         if(request.getParameter("deleteid")!=null){
                String del="delete from tbl_district where district_id='"+request.getParameter("deleteid")+"'";
                ...
                <%
                                ...
                                while(rs1.next()){
                                    ...
                                    <td><%=i%></td>
                                     ...
                                     <td><a href="District.jsp?deleteid=<%=rs1.getString("district_id")%>">Delete</a></td>
                                    </tr>
