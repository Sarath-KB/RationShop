    ...
    <body>
        ...
        <%
            if(request.getParameter("btnsub")!=null){
                String ins="insert into tbl_talukrequest(product_id,product_qty,talukofficer_id)values('"+request.getParameter("selp")+"','"+request.getParameter("txtquan")+"','"+session.getAttribute("userid")+"')";
        ...
        <form method="post">
            <table border="1" align="center" cellpadding="10" style="border-collapse: collapse;">
                ...
                <tr>
                <td>Quantity</td>
                <td><input type="text" name="txtquan" required=""></td>
                </tr>
                <tr>
