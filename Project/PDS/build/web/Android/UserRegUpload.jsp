<%-- 
    Document   : UserRegUpload
    Created on : 02-Jun-2021, 23:31:46
    Author     : hp -pc
--%>
...
if(isMultipart)
{
   ...
   String str1="insert into tbl_user(user_name,user_contact,user_email,user_address,user_gender,location_id,user_nomember,user_photo,user_proof,user_username,user_password)values('"+value[0]+"','"+value[1]+"','"+value[2]+"','"+value[3]+"','"+value[4]+"','"+value[7]+"','"+value[8]+"','"+fn+"','"+proof+"','"+value[10]+"','"+value[11]+"')";
    ...
    if(status==true)
    {
      %> 
       <script type="text/javascript">
            ...
            setTimeout(function(){window.location.href='UserReg.jsp'},40);//40millisecend it go to next page
        </script>
     <%
    }
     }    
