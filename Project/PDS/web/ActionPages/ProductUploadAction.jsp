<%-- 
    ...
    Created on : 29 Jan, 2020, 3:41:46 PM
    Author     : USER
--%>
...
if(isMultipart)
{
   ...
   String str1="insert into tbl_product(product_name,product_price,product_description,product_unit,product_photo,subcategory_id)"
                        + " values('"+value[2]+"','"+value[3]+"','"+value[4]+"','"+value[5]+"','"+fn+"',"
           + "'"+value[1]+"')";
    ...
    if(status==true)
    {
      %> 
       <script type="text/javascript">
            ...
            setTimeout(function(){window.location.href='Product.jsp'},40);//40millisecend it go to next page
        </script>
     <%
    }
     }    
