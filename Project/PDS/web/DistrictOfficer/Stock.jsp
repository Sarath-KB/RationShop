...
<html>
   ...
   {
     String ins="insert into tbl_districtstock(districtstock_number,districtstock_unit,districtproduct_id) values('"+stnumber+ "','"+stunit+ "','"+spid+"')";
   ...
   <%
    ...
    <table border="1" align="center" cellpadding="10">
            ...
            <%
            int i=1;
            String sel="select *from tbl_districtstock";
            ...
            <tr>
                <td><%= i %> </td>
                <td><%= rs.getString("districtstock_number") %> </td>
                 <td><%= rs.getString("districtstock_unit") %> </td>
                <td><a href="Stock.jsp?delid=<%=rs.getString("districtstock_id")%>">Delete</a></td>
