<%-- 
    Document   : MemberUpload
    Created on : 02-Jun-2021, 23:42:13
    Author     : hp -pc
--%>
...
if(isMultipart)
{
   ...
   String sel="select * from tbl_user where user_id='"+session.getAttribute("sid")+"'";
  ...
  if(count!=0){
   ...
   String str1="insert into tbl_member(member_name,member_photo,member_proof,user_id)values('"+value[0]+"','"+fn+"','"+proof+"','"+session.getAttribute("sid")+"')";
   ...
   out.println(str1);
    ...
    {
        count=count-1;
        String up="update tbl_user set user_nomember='"+count+"' where user_id='"+session.getAttribute("sid")+"'";
     ...
     <%
      ...
      String selc="select count(member_id) as id from tbl_member where user_id='"+session.getAttribute("sid")+"'";
      ResultSet rsc=con.selectCommand(selc);
      if(rsc.next()){
          count=Integer.parseInt(rs.getString("id"));
          count=count+1;
          String upc="update tbl_user set user_nomember='"+count+"' where user_id='"+session.getAttribute("sid")+"'";
