<%-- 
    Document   : Newuserlist.jsp
    Created on : 29 Jan, 2020, 8:39:51 PM
    Author     : USER
--%>
    ...
    <body>
        ...
        <form method="post">
            <table border="2" align="center" cellpadding="10" style="border-collapse: collapse;">
                ...
                <%
                    ...
                    int i=1;
                    String sel="select * from tbl_user u inner join tbl_location l on l.location_id=u.location_id inner join tbl_place p on p.place_id=l.place_id   where u.user_status=0 and p.place_id='"+session.getAttribute("pid")+"'";
        ...
        while(rs.next())
        {
              %>
                ...
                <td><a href="Newuserlist.jsp?acceptid=<%=rs.getString("user_id")%>">Accept/
                <a href="Newuserlist.jsp?rejectid=<%=rs.getString("user_id")%>">Reject</td>
                </tr>
