...
<html>
   ...
   {
     String ins="insert into tbl_talukstock(talukstock_number,talukstock_unit,talukproduct_id) values('"+stnumber+ "','"+stunit+ "','"+spid+"')";
   ...
   <%
    if(request.getParameter("delid")!=null)
        {
                boolean delCheck;
                String del="delete from tbl_talukstock where talukstock_id='"+request.getParameter("delid")+"'";
    ...
    <table border="1" align="center" cellpadding="10">
            ...
            <%
            int i=1;
            String sel="select *from tbl_talukstock";
            ...
            <tr>
                <td><%= i %> </td>
                <td><%= rs.getString("talukstock_number") %> </td>
                 <td><%= rs.getString("talukstock_unit") %> </td>
                <td><a href="Stock.jsp?delid=<%=rs.getString("talukstock_id")%>">Delete</a></td>
