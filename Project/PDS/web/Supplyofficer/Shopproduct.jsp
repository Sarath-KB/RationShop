...
function getproduct(d)
{
    ...
    <body>
        ...
        {
             String ins="insert into tbl_talukproduct(talukofficer_id,product_id) values('"+session.getAttribute("userid")+ "','"+selname3+ "')";
        ...
        {
                boolean delCheck;
                String del="delete from tbl_talukproduct where talukproduct_id='"+request.getParameter("delid")+"'";
    ...
    <form method="post">
        ...
        <%
            int i=1;
            String sel0="select * from tbl_talukproduct s inner join tbl_product p on p.product_id=s.product_id inner join tbl_subcategory sb on sb.subcategory_id=p.subcategory_id inner join tbl_category c on c.category_id=sb.category_id";
            ...
            <tr colspan="2" align="center">
                ...
                <th><a href="Shopproduct.jsp?delid=<%=rs0.getString("talukproduct_id") %>">Delete</a></th>
                <th><a href="Stock.jsp?spid=<%=rs0.getString("talukproduct_id") %>">Add Stock</a></th>
            </tr>
            <%
            i++;
            }
