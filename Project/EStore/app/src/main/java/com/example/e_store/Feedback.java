...
public class Feedback extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnFeddback = findViewById(R.id.btnfeedback);

        btnFeddback.setOnClickListener(this);

    }

    @Override
    public void onClick(View view) {
        fcontent = et_feed.getText().toString();
        feedbackDetails d = new feedbackDetails();
        d.execute(cid,shopid,fcontent);
    }

    class feedbackDetails extends AsyncTask<String,String,String> {
        @Override
        protected String doInBackground(String... params) {
            WebServiceCaller caller=new WebServiceCaller(getApplicationContext());
            caller.setSoapObject("feedback");
