...
public class AddMember extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webview.loadUrl("http://192.168.1.4:8080/PDS/Android/AddCard.jsp?id="+uid);
        Log.d("url link","http://192.168.1.4:8080/PDS/Android/AddCard.jsp?id="+uid);
    ...
    public void onClick(View view) {
        Intent i=new Intent(AddMember.this,Homepage.class);
        startActivity(i);
    }
